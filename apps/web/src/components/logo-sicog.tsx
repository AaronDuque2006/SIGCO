 ...
 *
 * El naranja y el azul son del logo, no de la interfaz: el Azul Señal
 * (#3b82f6) coincide con el del sistema, y el naranja existe sólo acá. El
 * texto y las letras toman `currentColor`, y el fondo de los instrumentos el
 * de la tarjeta, para que se lea en los dos temas.
 */
...
export function SelloSicog({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* Aros */}
      <circle cx="256" cy="256" r="244" fill="none" stroke="#ea7a2b" strokeWidth="9" />
      <circle cx="256" cy="256" r="186" fill="none" stroke="#3b82f6" strokeWidth="3.5" />
      <circle
        cx="256"
        cy="256"
        r="175"
      ...
      />
      <circle cx="44" cy="256" r="7" fill="#ea7a2b" />
      <circle cx="468" cy="256" r="7" fill="#ea7a2b" />
      {/* Textos */}
      <text
      ...
      <circle cx="256" cy="252" r="11" fill="#3b82f6" />
      ...
      <g fill="var(--card)" stroke="#3b82f6" strokeWidth="3">
      ...
      <g fill="none" stroke="#3b82f6" strokeWidth="3" strokeLinecap="round">
        ...
        <circle cx="256" cy="343" r="4.5" fill="#3b82f6" />
        <path d="M315,282 L315,269 M309,268 L321,268" />
      </g>
      <path d="M302,274 L328,290 L328,274 L302,290 Z" fill="#3b82f6" />
      <g
        fontFamily="Inter, system-ui, sans-serif"
        fontWeight="800"
        fontSize="17"
...
export function MarcaSicog({ className }: { className?: string }) {
  ...
  return (
    <svg viewBox="0 0 64 64" className={className} aria-hidden>
      ...
      <circle cx="32" cy="32" r="28.5" fill="none" stroke="#ea7a2b" strokeWidth="5" />
      <g stroke="#3b82f6" strokeWidth="2.6" strokeLinecap="round">
        <path d="M32,46 L13,40 M32,46 L51,40 M32,46 L32,55" />
      </g>
      <circle cx="13" cy="40" r="3" fill="#3b82f6" />
      <circle cx="51" cy="40" r="3" fill="#3b82f6" />
      <circle cx="32" cy="55" r="3" fill="#3b82f6" />
      <path
      ...
      <path
        ...
        fill="#dbeafe"
      />
      <circle cx="32" cy="46" r="4.5" fill="#1d4ed8" />
    </svg>
  );
}
