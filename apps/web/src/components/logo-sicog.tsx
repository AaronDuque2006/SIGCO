...
export function SelloSicog({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      ...
      {/* El flujo: pulsos claros sobre las mismas líneas, del nodo central
          hacia afuera (cada tramo empieza en el nodo más cercano al centro). */}
      <path
        className="logo-flujo"
        d="M256,252 L197,282 M256,252 L315,282 M256,252 L256,334 M256,252 L186,214 M256,252 L328,208 M186,214 L148,238 M328,208 L370,232 M328,208 L352,172 M148,238 L170,300"
        fill="none"
