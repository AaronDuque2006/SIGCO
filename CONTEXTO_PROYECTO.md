...
2. Balance diario: 2 cortes al día (puntual y cierre_promedio).
...
14. Quema de gas a nivel nacional, tabla `QUEMA_NACIONAL` (`fecha`, `tipo_corte`, `mmpced`), digitado manualmente.
