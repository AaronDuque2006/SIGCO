...
export type ListCatalogoActividadesQuery = z.infer<typeof listCatalogoActividadesQuerySchema>;
...
export type PlanVsRealQuery = z.infer<typeof planVsRealQuerySchema>;
export type ParticipacionQuery = z.infer<typeof participacionQuerySchema>;
