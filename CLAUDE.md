...
**Not built**: Mantenimiento's telemetry and stations — modelled and closed from the start, with no API or screens, and shown dimmed in its menu. Análisis Operacional and Calidad de Gas remain undesigned because **no source spreadsheet exists for either**.
